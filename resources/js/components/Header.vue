  ...
  <div class="flex px-8 py-2 items-center text-gray-100 top-0 bg-indigo-900 dark:bg-indigo-900">
    <div class="mr-auto flex items-center space-x-8">
      ...
      <div>
        <div
          ref="topicsMenu"
          @mouseover="showTopicsMenu"
          @mouseleave="closeTopicsMenu"
            ...
            <div class="grid grid-cols-3">
              <div class="col-span-2 border-r border-gray-200 dark:border-gray-700 p-4">
                ...
                <div class="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 p-2 rounded-md">
                  ...
                  <div class="text-xs text-gray-500">Powerful Node.js backend framework</div>
                </div>
      ...
      <div>
        <div
          ...
          class="text-gray-200 font-medium group cursor-pointer select-none"
          ref="coursesMenu"
          @mouseover="showCoursesMenu"
          @mouseleave="closeCoursesMenu"
          v-on-clickaway="closeCoursesMenuNow"
        >
          Courses
          <svg
            xmlns="http://www.w3.org/2000/svg"
